...
このドキュメントは、OshiCall プラットフォームのインフルエンサーを管理するための運営向けガイドです。
...
```
件名: OshiCall インフルエンサー承認のお知らせ

{ユーザー名} 様

この度は、OshiCallのインフルエンサーにご応募いただき、
誠にありがとうございます。
